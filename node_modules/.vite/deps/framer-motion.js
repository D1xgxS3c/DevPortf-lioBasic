...
function useCycle() {
  ...
  var runCycle = (0, import_react47.useCallback)(function(next) {
...
function useInView(ref, _a) {
  ...
  var _d = __read((0, import_react48.useState)(false), 2), isInView = _d[0], setInView = _d[1];
...
function useAnimatedState(initialState) {
  var _a = __read((0, import_react50.useState)(initialState), 2), animationState = _a[0], setAnimationState = _a[1];
